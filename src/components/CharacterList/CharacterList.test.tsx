...
const mockCharacters: Character[] = [
    { id: 1, name: "Iron Man", thumbnail: {
        path: "",
        extension: "jpg"
    } },
    { id: 2, name: "Captain America", thumbnail: {
        path: "",
        extension: "jpg"
    } },
    { id: 3, name: "Thor", thumbnail: {
        path: "",
        extension: "jpg"
    } },
];
...
describe("CharacterList", () => {
    ...
    it("should render the list of characters correctly", () => {
        render(<CharacterList characters={mockCharacters} navigate={useNavigate()} />);
    ...
    it("should navigate to the character detail page when a character is clicked", () => {
        ...
        characterItems.forEach((characterItem, index) => {
            characterItem.click();
            expect(navigateMock).toHaveBeenCalledWith(`/character/${mockCharacters[index].id}`);
        });
    });
});